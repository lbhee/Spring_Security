...
<div id="header">
	<div class="top-wrapper">
	   ...
	   <%--
		...
		<!-- Spring이 제공하는 taglib로 처리하기! -->
		<se:authorize access="!hasRole('ROLE_USER')">
			<li>
				<a href="${pageContext.request.contextPath}/joinus/login.do">로그인</a>
			</li>
		</se:authorize>
		<!-- userPrincipal.name -->
		<se:authentication property="name" var="loginuser" />  <!-- 인증에서 name속성을 가져와서 변수에 담는 코드 -->
		...
		<ul id="membermenu" class="clear">
			<li><a href="${pageContext.request.contextPath}/joinus/memberconfirm.do"><img src="${pageContext.request.contextPath}/images/menuMyPage.png" alt="마이페이지" /></a>
			</li>
			<li>
